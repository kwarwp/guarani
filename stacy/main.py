...
def dogatthebeach():
    ...
    funnydog = Elemento("https://vignette.wikia.nocookie.net/steven-universe/images/0/06/Funny_dog.png/revision/latest?cb=20150717003538", tit = "FUNNYDOG",  style = dict(left = 50, top = 60, widht = 60, height = 50))
